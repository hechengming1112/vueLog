<template>
  <el-container>
    <el-header class="cate_mana_header">
      <el-input placeholder="请输入栏目名称" v-model="cateName" style="width: 200px"></el-input>
    ...
    <el-main class="cate_mana_main">
      ...
      >
        ...
        <el-table-column label="编号" prop="id" width="120" align="left"></el-table-column>
        <el-table-column prop="cateName" label="栏目名称" width="120" align="left"></el-table-column>
